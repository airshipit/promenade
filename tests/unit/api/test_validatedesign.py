    ...
    },
    {
        'data': {
            ...
            'images': {
                ...
                'kubernetes': {
                    'apiserver':
                    'registry.k8s.io/kube-apiserver-amd64:v1.27.2',
                    'controller-manager':
                    'registry.k8s.io/kube-controller-manager-amd64:v1.27.2',
    ...
    },
    {
        'data': {
            'files': [{
                ...
                'tar_url':
                'https://dl.k8s.io/v1.27.2/kubernetes-node-linux-amd64.tar.gz'
            }, {
                'content':
