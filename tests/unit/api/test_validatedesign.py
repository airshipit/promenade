    ...
    },
    {
        'data': {
            ...
            'images': {
                ...
                'kubernetes': {
                    'apiserver':
                    'registry.k8s.io/kube-apiserver-amd64:v1.28.4',
                    'controller-manager':
                    'registry.k8s.io/kube-controller-manager-amd64:v1.28.4',
                    'etcd': 'quay.io/coreos/etcd:v3.5.6',
                    'scheduler': 'registry.k8s.io/kube-scheduler-amd64:v1.28.4'
                }
            },
            'ip':
            '192.168.77.10',
    ...
    },
    {
        'data': {
            'files': [{
                ...
                'tar_url':
                'https://dl.k8s.io/v1.28.4/kubernetes-node-linux-amd64.tar.gz'
            }, {
                'content':
