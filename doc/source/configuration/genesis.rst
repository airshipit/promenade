...
.. code-block:: yaml
    ...
    data:
      ...
      images:
        ...
        kubernetes:
          apiserver: registry.k8s.io/kube-apiserver-amd64:v1.36.1
          controller-manager: registry.k8s.io/kube-controller-manager-amd64:v1.36.1
          etcd: quay.io/coreos/etcd:v3.5.12
          etcdctl: quay.io/airshipit/porthole-etcdctl-utility:latest-ubuntu_noble
